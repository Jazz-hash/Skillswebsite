...
exports.createPages = async ({ graphql, actions }) => {
  ...
  console.log(
    JSON.stringify("Envirnoment Variable in gatsby-node: " + companyIndex)
  );

  const availablePrograms =
    detailProgram.data.allContentfulFranchisee.edges[1].node.courseCatalog
      .programsAvailable;

  const instructors =
    detailProgram.data.allContentfulFranchisee.edges[1].node.instructors;
